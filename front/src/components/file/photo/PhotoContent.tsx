...
interface PhotoContentGridProps {
	datas: Array<FileInfo>;
}

const PhotoContentGrid: FC<PhotoContentGridProps> = ({
	datas,
}): JSX.Element => {
	return (
...
const PhotoContent: FC<PhotoContentProps> = ({ actions }): JSX.Element => {
